...
import com.aulas.cursoangular.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva" , "maria@gmail.com", "08902976300", TipoCliente.PESSOAFISICA, bc.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("992202235","988696948"));
		
		
		Cliente cli2 = new Cliente(null, "Ana Costa" , "gudshugo@gmail.com", "02817657314", TipoCliente.PESSOAFISICA, bc.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("55555555","777777778"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "65073270", cli1, c1);
		Endereco e2 = new Endereco(null, "Av. Matos", "105", "Sala 800", "Centro", "65000000", cli1, c2);
		Endereco e3 = new Endereco(null, "Av. Floriano", "2008", "Quadra 10", "Centro", "65000000", cli2, c2);
